...
@Component({
  selector: 'app-admin-cedulas-detalle',
  templateUrl: './admin-cedulas-detalle.component.html',
  styleUrls: ['./admin-cedulas-detalle.component.css']
})
export class AdminCedulasDetalleComponent implements OnInit {
  ...
  getTotalCedulas() {
    this.spinner.show();
    this.estadisticasService.getEstadisticasCedulaPreguntasTotal(this.clues, this.cedula).subscribe((response: any) => {
  ...
  getCedulas() {
    this.spinner.show();
    this.catalogoService.getCedulas(this.clues).subscribe((response: any) => {
  ...
  getCuestionarios(): void {
    this.spinner.show();
    this.estadisticasService.getEstadisticasCedulaPreguntas(this.clues, this.cedula, this.page).subscribe((response: any) => {
      switch (response.status) {
        case 200:
