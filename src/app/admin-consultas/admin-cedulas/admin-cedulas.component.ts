...
@Component({
  selector: 'app-admin-consulta-cedulas',
  templateUrl: './admin-cedulas.component.html',
  styleUrls: ['./admin-cedulas.component.css']
})
export class AdminConsultaCedulasComponent implements OnInit {
  ...
  getUnidades(idEntidad){
    ...
    this.spinner.show();
    this.catalogoService.getUnidades(this.token,idEntidad,jurisdiccion,nivel  ).subscribe((response: any) => {
        this.spinner.hide();
        switch (response.status) {
          case 200:
  ...
  getCuestionarios() : void {
    ...
    this.estadisticasService.getEstadisticasCedulas(this.token,
            idEntidad,
            jurisdiccion,
            nivel,
            clues, 
  ...
  getCuestionariosTotal() : void {
    ...
    this.estadisticasService.getEstadisticasCedulasTotal(this.token,
            idEntidad,
            jurisdiccion,
            nivel,
            clues
