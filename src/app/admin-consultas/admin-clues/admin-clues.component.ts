...
@Component({
  selector: 'app-admin-consulta-clues',
  templateUrl: './admin-clues.component.html',
  styleUrls: ['./admin-clues.component.css']
})
export class AdminConsultaCluesComponent implements OnInit {
    ...
    getJurisdicciones(){
      ...
      this.catalogoService.getJurisdiccion(idEntidad,this.rol).subscribe((response: any) => {
          this.spinner.hide();
    ...
    getEntidadesFederativas() : void{
        this.spinner.show();
        this.catalogoService.getEntidadesFederativas(1,this.rol).subscribe((response: any) => {
            this.spinner.hide();
            switch (response.status) {
              case 200:
    ...
    getCluesDescargar(){
        ...
        this.catalogoService.getCluesByEntidad(this.formDescarga.get('idEntidadDescarga').value,this.rol,this.formDescarga.get('jurisdiccion').value,idNivel).subscribe((response: any) => {
            this.spinner.hide();
            switch (response.status) {
              case 200:
    ...
    getFilesAll() {
        ...
        this.archivosService.getAll(0,clues,this.formDescarga.get('tipoArchivo').value,this.page).subscribe((response: any) => {
          this.spinner.hide();
          switch (response.status) {
            case 200:
    ...
    getTotalFiles(){
      ...
      this.archivosService.getFilesTotal(0,clues,this.formDescarga.get('tipoArchivo').value).subscribe((response: any) => {
        this.spinner.hide();
        switch (response.status) {
          case 200:
